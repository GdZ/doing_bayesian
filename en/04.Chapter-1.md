...
- Chapter 14: Statistical power analysis and planning of reasearch, from a Bayesian perspective. This chapter is not essential on a first reading, but it's important not to skip forever. After all, failing to plan is planning to fail.
